...
import moe.sekiu.appara_mcalculator.databinding.FragmentChooseAppBinding
...
class ChooseAppFragment: BaseViewModelFragment<ChooseAppViewModel, FragmentChooseAppBinding>() {
    ...
    private val calculatorViewModel by hiltNavGraphViewModels<CalculatorViewModel>(R.id.calculatorFragment)
    ...
    private val onAppClicked: (InstalledApp) -> Unit = {
        calculatorViewModel.packageName = it.packageName
